...
const EmployeesSearch = React.createClass({
	displayName: 'Owner',
	propTypes: {
	...
	render () {
		...
		return (
			<div className="section">
				...
				<AsyncComponent multi={this.state.multi} value={this.state.value} onChange={this.onChange} onValueClick={this.gotoUser} valueKey="_id" labelKey="name" loadOptions={this.getUsers} backspaceRemoves={this.state.backspaceRemoves} />
